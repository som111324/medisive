...
const features = [
    {
        ...
        description:
            "Simply speak naturally during patient consultations. Our AI captures and transcribes your voice in real-time with high accuracy.",
    },
    {
        icon: <Languages className="h-12 w-12 text-primary-500" />,
        title: "Multilingual Support",
        description:
            "Communicate in Hindi, English, Tamil, Telugu, and other Indian languages. Our system understands regional accents and medical terminology.",
    },
    {
        icon: <FileText className="h-12 w-12 text-primary-500" />,
        title: "AI-Generated Smart Summaries",
        description:
            "Convert lengthy consultations into concise, structured clinical notes with key findings, diagnoses, and treatment plans highlighted.",
    },
    {
        icon: <Server className="h-12 w-12 text-primary-500" />,
        title: "Seamless EMR Integration",
        description:
            "Integration-ready with popular electronic medical record systems used in Indian hospitals and clinics for streamlined workflow.",
    },
];
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center">
                    ...
                    <p className="mx-auto mt-4 max-w-2xl text-lg text-secondary-600">
                        Our AI-powered platform simplifies the clinical
                        documentation process, allowing you to focus on patient
                        care.
                    </p>
                </div>
                ...
                {/*                         See how Croww transforms the way doctors in */}
                {/*                         India create and manage clinical */}
                {/*                         documentation. Get started with a free trial */}
                {/*                         today. */}
                {/*                     </p> */}
                {/*                 </div> */}
