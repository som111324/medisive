            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-3xl text-center">
                    <h2 className="text-3xl font-bold tracking-tight text-secondary-900 sm:text-4xl">
                        Why Indian Healthcare Needs Croww
                    </h2>
                    <p className="mt-4 text-lg text-secondary-600">
                        Addressing the unique documentation challenges faced by
                    ...
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                        <div className="relative rounded-2xl bg-white p-6 shadow-md transition-transform duration-300 hover:-translate-y-1">
                            ...
                            <div className="mt-4 pt-4">
                                ...
                                <p className="mt-3 text-base text-secondary-600">
                                    Indian doctors spend up to 30% of their time
                                    on documentation, reducing patient
                                    interaction time. Croww cuts documentation
                                    time by 70%, allowing more focus on patient
                                    care.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="relative rounded-2xl bg-white p-6 shadow-md transition-transform duration-300 hover:-translate-y-1">
                            ...
                            <div className="mt-4 pt-4">
                                ...
                                <p className="mt-3 text-base text-secondary-600">
                                    With high patient volumes in Indian
                                    healthcare settings, manual documentation
                                    creates bottlenecks. Our AI-powered solution
                        ...
                        <div className="relative rounded-2xl bg-white p-6 shadow-md transition-transform duration-300 hover:-translate-y-1">
                            ...
                            <div className="mt-4 pt-4">
                                ...
                                <p className="mt-3 text-base text-secondary-600">
                                    Many existing solutions don't support Indian
                                    languages or account for regional accents.
                                    Croww is built from the ground up with
                                    multilingual support for Indian healthcare.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="relative rounded-2xl bg-white p-6 shadow-md transition-transform duration-300 hover:-translate-y-1">
                            ...
                            <div className="mt-4 pt-4">
                                ...
                                <p className="mt-3 text-base text-secondary-600">
                                    Indian healthcare requires strict adherence
                                    to local data protection regulations. Our
                                    platform is fully compliant with Indian
                                    healthcare data standards and HIPAA
                                    guidelines.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="px-6 py-12 sm:px-12 sm:py-16 md:flex md:items-center md:justify-between">
                        <div>
                            ...
                            <p className="mt-3 text-lg text-primary-100">
                                Join thousands of Indian healthcare
                                professionals already saving hours each day.
                            </p>
                        </div>
