        ...
        <div className="flex h-16 items-center justify-between">
          <div className="flex items-center">
            <Link to="/" className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-secondary-900">MedScribe AI</span>
            </Link>
          </div>
          ...
          <nav className="hidden md:flex space-x-10">
            ...
            <a href="#how-it-works" className="text-secondary-600 hover:text-primary-600 font-medium">
              How It Works
            </a>
            <a href="#why-needed" className="text-secondary-600 hover:text-primary-600 font-medium">
              Why It's Needed
            </a>
          </nav>
              ...
              {isAuthenticated ? (
                ...
                <>
                  ...
                  <Link to="/auth/signup" onClick={() => setIsOpen(false)}>
                    <Button variant="primary" fullWidth>Signup</Button>
                  </Link>
                </>
              )}
            </div>
